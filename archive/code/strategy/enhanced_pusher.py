        ...
        if stock_data is not None and alpha_scores is not None:
            ...
            if plan.actions:
                ...
                if build_stocks:
                    ...
                    content.append(f"• 建仓时间: 9:30-11:30（分散执行）")
                    content.append(f"• 第一批(30%): 9:30-10:00")
                    content.append(f"• 第二批(30%): 10:00-10:30")
                    content.append(f"• 第三批(40%): 10:30-11:30")
                ...
                content.append("• 建仓时间建议: 9:30-11:30（分散执行）")
